...
PositionController::PositionController (float velocity, float tolerance){
  ...
  this->fleft_wheel = new VescAccess (FRONT_LEFT_WHEEL_ID, gear_ratio, output_ratio, max_velocity, max_torque, torque_constant, name, pole_pairs );

  this->fright_wheel = new VescAccess (FRONT_RIGHT_WHEEL_ID, gear_ratio, output_ratio, max_velocity, max_torque, torque_constant, name, pole_pairs );

  this->bright_wheel = new VescAccess (BACK_RIGHT_WHEEL_ID, gear_ratio, output_ratio, max_velocity, max_torque, torque_constant, name, pole_pairs );
  this->bleft_wheel = new VescAccess (BACK_LEFT_WHEEL_ID, gear_ratio, output_ratio, max_velocity, max_torque, torque_constant, name, pole_pairs );
}

PositionController::PositionController (float velocity, float tolerance, iVescAccess *fl, iVescAccess *fr, iVescAccess *br, iVescAccess *bl){
  setVelocity (velocity);
  setTolerance (tolerance);
  this->bleft_wheel = bl;
