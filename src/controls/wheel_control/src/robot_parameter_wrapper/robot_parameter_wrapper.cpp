...
RobotParameterWrapper::RobotParameterWrapper(uint8_t VESC_ID, float transmission_ratio, float output_ratio,
                                             float velocity_limit, float torque_limit, float torque_constant,
                                             char *can_network)
{
  RobotParameterWrapper(transmission_ratio, output_ratio, velocity_limit, torque_limit, torque_constant,
