                       ...
                       double wristBottomLimit, double wristUpperLimit)
{
  ...
  sh = new SimVesc(16, 0, 3.0, shoulderTheta, shoulderBottomLimit, shoulderUpperLimit, true, 1.0);
  wr = new SimVesc(16, 0, 3.0, wristTheta, wristBottomLimit, wristUpperLimit, false, 0);
}
